...
<html>
<head>
<title>Admin Issue Book :: Library Administration</title>
							...
							<button type="button" class="close" onclick="$('.alert').addClass('hidden');">&times;</button>
									...
									<form class="form form-horizontal" id="issbk" data-toggle="validator" method="post">
										<div class="form-group">
											<label for="rfid" class="col-sm-4 control-label">User LBID</label>
											<div class="col-md-8">
												<div class="input-group">
													<input type="text" class="form-control1" placeholder="LBID" id="rfid" name="rfid" autocomplete="off" autofocus data-error="Please read the LBID card." required >
												</div>
											<span id="rfidr"></span>
											<span id="name"></span>
											<span id="user"></span>
